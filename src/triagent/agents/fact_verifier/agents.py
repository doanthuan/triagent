...
from triagent.agents.fact_verifier.prompts import (
    claim_extractor_prompt,
    double_check_prompt,
    fact_check_prompt,
)
from triagent.agents.fact_verifier.tools import search_exa_literature
from triagent.agents.fact_verifier.utils import parse_json_safe
...
fact_verifier_agent = FactVerifierOrchestrator()